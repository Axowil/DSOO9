...
public class FrmAgregarUsuarios extends JFrame {
    ...
    private boolean clienteTieneUsuario(String dni) {
        // Buscar en los usuarios existentes si ya hay un usuario para este cliente
    ...
    private boolean empleadoTieneUsuario(String dni) {
        // Buscar en los usuarios existentes si ya hay un usuario para este empleado
        for (Usuario usuario : gestorUsuarios.getUsuarios()) {
            if (usuario instanceof UsuarioEmpleado) {
                    UsuarioEmpleado usuarioEmpleado = (UsuarioEmpleado) usuario;
    ...
    private void guardarUsuario() {
        ...
        try {
            ...
            switch (tipoSeleccionado) {
                ...
                case "Empleado":
                    // Buscar empleado por DNI usando el gestor
            ...
            if (nuevoUsuario != null) {
                // Usar el método agregarUsuario del gestor que ya tienes
